      ...
      <div class="flex flex-wrap -m-4">
        <div class="w-full md:w-1/2 lg:w-1/4 p-4">
          <div class="p-6 rounded bg-white">
            <div class="flex mb-2">
              <h3 class="text-sm text-gray-600">Ethereum</h3>
              <span
                class="inline-block ml-auto px-2 py-1 text-xs text-gray-500 bg-gray-50 rounded-full"
                >30 Days</span
              >
            </div>
            <h2 class="mb-2 text-3xl font-bold">ETH</h2>
        ...
        <div class="w-full md:w-1/2 lg:w-1/4 p-4">
          <div class="p-6 rounded bg-white">
            <div class="flex mb-2">
              <h3 class="text-sm text-gray-600">Cardano</h3>
              <span
                class="inline-block ml-auto px-2 py-1 text-xs text-gray-500 bg-gray-50 rounded-full"
                >30 Days</span
              >
            </div>
            <h2 class="mb-2 text-3xl font-bold">ADA</h2>
        ...
        <div class="w-full md:w-1/2 lg:w-1/4 p-4">
          <div class="p-6 rounded bg-white">
            <div class="flex mb-2">
              <h3 class="text-sm text-gray-600">Swipe</h3>
              <span
                class="inline-block ml-auto px-2 py-1 text-xs text-gray-500 bg-gray-50 rounded-full"
                >30 Days</span
              >
            </div>
            <h2 class="mb-2 text-3xl font-bold">SXP</h2>
            <span class="text-xs text-green-500">
              <span class="inline-block mr-2">
                <svg
                  width="18"
        ...
        <div class="w-full md:w-1/2 lg:w-1/4 p-4">
          <div class="p-6 rounded bg-white">
            <div class="flex mb-2">
              <h3 class="text-sm text-gray-600">Sandbox</h3>
              <span
                class="inline-block ml-auto px-2 py-1 text-xs text-gray-500 bg-gray-50 rounded-full"
                >30 Days</span
              >
            </div>
            <h2 class="mb-2 text-3xl font-bold">SAND</h2>
            <span class="text-xs text-red-500">
              <span class="inline-block mr-2">
                <svg
                  width="18"
